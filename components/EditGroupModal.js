...
export default function EditGroupModal({ visible, onClose, group, onSave, onDelete }) {
    ...
    const handleSave = () => {
        ...
        onSave({ ...group, name: name.trim(), description: desc.trim(), tags: updatedTags });
    };
            ...
            <View style={styles.overlay}>
                <GlassView style={styles.modal} intensity={90}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <TextInput value={name} onChangeText={setName} placeholder="Group name" placeholderTextColor="#aaa" style={styles.input} />
                        <TextInput value={desc} onChangeText={setDesc} placeholder="Description" placeholderTextColor="#aaa" style={[styles.input, { height: 100 }]} multiline />
                        <TextInput value={tags} onChangeText={setTags} placeholder="Tags (comma separated)" placeholderTextColor="#aaa" style={styles.input} />
                        ...
                        <View style={styles.buttons}>
                            ...
                            <TouchableOpacity style={styles.save} onPress={handleSave}><Text style={styles.saveText}>Save</Text></TouchableOpacity>
                        </View>
                        <TouchableOpacity style={styles.deleteBtn} onPress={() => onDelete(group.id)}>
