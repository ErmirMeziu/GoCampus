                        ...
                        <GlassView style={styles.card} intensity={90}>
                            ...
                            <ScrollView showsVerticalScrollIndicator={false}>
                                ...
                                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 10 }}>
                                    {groups.map((g) => (
                                        <TouchableOpacity
                                            ...
                                            style={[
                                                styles.chip,
                                                { backgroundColor: g.id === groupId ? "#0072ff" : "rgba(255,255,255,0.15)" },
                                            ]}
                                        >
                                ...
                                <View style={styles.row}>
                                    ...
                                    <TouchableOpacity
                                        style={[styles.btn, { backgroundColor: "#0072ff", opacity: title.trim() ? 1 : 0.5 }]}
                                        disabled={!title.trim()}
...
const styles = StyleSheet.create({
    ...
    input: { borderRadius: 12, padding: 12, marginBottom: 10, backgroundColor: "rgba(255,255,255,0.12)", color: "#fff" },
